...
// apiKey is pulled out of opts so it never leaks into the fetch init. Passing
// '' suppresses the header entirely (login must not send one); omitting it
// uses the key saved at login. withHeaders returns the response headers
// alongside the body, which is how login picks up the key the server issues.
